package com.example.howtodoinjava.apigateway.controller;
...
public class EmployeeController {
	private static final String EMPLOYEE_SERVICE = "http://employee-service/";
	@Autowired
	...
	public String getStudents(@PathVariable int employeeid) {
		...
		String response = restTemplate.exchange(EMPLOYEE_SERVICE + "employeedetails/{employeeid}", HttpMethod.GET, null,
